    ...
    <div class="login-background">
        <div class="login">
            ...
            <form class="full-width-form" @submit="login">
                ...
                <button type="submit" id="signIn" class="mdc-button mdc-button--raised">
            ...
            <button type="submit" id="googleSignIn" @click="socialLogin" class="mdc-button mdc-button--raised">
